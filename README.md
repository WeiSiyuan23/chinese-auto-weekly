...
![Chinese Auto Weekly report sample](assets/cover.png)

*A real report generated by this skill — click for the [full-length PNG](assets/report-full.png) or the [interactive HTML](examples/report.sample.html).*
